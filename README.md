...
```bash
npm install puppeteer-nest puppeteer
```
...
import { PuppeteerModule } from 'puppeteer-nest/core';
...
import { PuppeteerService } from 'puppeteer-nest/core';
...
```ts
import { Injectable } from '@nestjs/common';
import { InjectBrowser, InjectPage } from 'puppeteer-nest';
...
import { createMockPuppeteerProviders, PuppeteerService } from 'puppeteer-nest';
